...
var options = { method: 'GET',
    url: 'http://'+fdbSet.fdbConfig.ip+':'+fdbSet.fdbConfig.port+'/rest/services/manageService/logicalDatasources/ps_MODEL_20170725105_FDB/datasets/building/featureClasses',
